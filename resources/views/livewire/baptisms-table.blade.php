<div class="container">
            ...
            <tbody>
                ...
                @forelse($baptisms as $baptism)
                    ...
                    {{-- <tr class="py-2" wire:key="baptism-{{ $baptism->id }}"> --}}
                        ...
                        <td>{{ $id++ }}</td>
                        <td>
                            {{ optional($baptism->father)->firstname }}
                            {{ optional($baptism->father)->middlename }}
                            {{ optional($baptism->father)->lastname ?? 'Father not found' }}
                        </td>
                        <td>
                            {{ optional($baptism->mother)->firstname }}
                            {{ optional($baptism->mother)->middlename }}
                            {{ optional($baptism->mother)->lastname ?? 'Mother not found' }}
                        </td>
                        <td>{{ $baptism->baby_firstname . ' ' . $baptism->baby_middlename . ' ' . $baptism->baby_lastname }}
                        </td>
                        <td>{{ $baptism->dateOfBirth }}</td>
                        <td>{{ $baptism->age }}</td>
                        <td>{{ $baptism->dateOfBaptism }}</td>
                                ...
                                <ul class="dropdown-menu" style="z-index: 1000;">
                                    <li>
                                        <button type="button" class="dropdown-item text-secondary"
                                            ...
                                            data-bs-target="#viewBaptismModal{{ $baptism->id }}"
                                    ...
                                    <li>
                                        <button type="button" class="dropdown-item text-success" data-bs-toggle="modal"
                                            data-bs-target="#editBaptismModal{{ $baptism->id }}"
                                            style="cursor: pointer;">
                                    ...
                                    <li>
                                        <button type="button" class="dropdown-item text-danger"
                                            ...
                                            data-bs-target="#deleteBaptismModal{{ $baptism->id }}">
                                            <i class="bi bi-trash-fill me-1"></i> Futa
                                        </button>
                                    </li>
                                </ul>
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        <h1 class="modal-title fs-5" id="viewBaptismModal{{ $baptism->id }}Label">Tazama Ubatizo
                        </h1>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text"
                                        value="{{ $baptism->father->firstname . ' ' . $baptism->father->middlename . ' ' . $baptism->father->lastname . '(' . $baptism->father->member_id . ')' }}"
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text"
                                        value="{{ $baptism->mother->firstname . ' ' . $baptism->mother->middlename . ' ' . $baptism->mother->lastname . '(' . $baptism->mother->member_id . ')' }}"
                                        class="form-control fw-bold" readonly>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text"
                                        value="{{ $baptism->baby_firstname . ' ' . $baptism->baby_middlename . ' ' . $baptism->baby_lastname }}"
                                        class="form-control fw-bold" readonly>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" value="{{ $baptism->dateOfBirth }}"
                                        class="form-control fw-bold" readonly>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="text" value="{{ $baptism->age }}" class="form-control fw-bold"
                                        readonly>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="text" value="{{ $baptism->dateOfBaptism }}"
                                        class="form-control fw-bold" readonly>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="text" value="{{ $baptism->status }}"
                                        class="form-control fw-bold" readonly>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text"
                                        value="{{ $baptism->user->name . '(' . $baptism->user->user_type . ')' }}"
                                        class="form-control fw-bold" readonly>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" value="{{ $baptism->created_at }}"
                                        class="form-control fw-bold" readonly>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <label for="father_member_id" class="form-label">Jina la Baba (Namba)</label>
                                    <input type="text"
                                        value="{{ optional($baptism->father)->firstname . ' ' . optional($baptism->father)->middlename . ' ' . optional($baptism->father)->lastname . ' (' . optional($baptism->father)->member_id . ')' }}"
                                        class="form-control fw-bold" readonly>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <label for="mother_member_id" class="form-label">Jina la Mama (Namba)</label>
                                    <input type="text"
                                        value="{{ optional($baptism->mother)->firstname . ' ' . optional($baptism->mother)->middlename . ' ' . optional($baptism->mother)->lastname . ' (' . optional($baptism->mother)->member_id . ')' }}"
                                        class="form-control fw-bold" readonly>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <label for="user_id" class="form-label">Alie Unda</label>
                                    <input type="text"
                                        value="{{ optional($baptism->user)->name . ' (' . optional($baptism->user)->user_type . ')' }}"
                                        class="form-control fw-bold" readonly>
                                </div>
                            </div>
                            <div class="col-md-6">
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <form action="{{ route('admin.edit.baptism') }}" method="POST" x-data="{ loading: false }"
                        ...
                        @csrf
                        <div class="modal-header">
                            <h1 class="modal-title fs-5" id="editBaptismModal{{ $baptism->id }}Label">Hariri Ubatizo
                            </h1>
                            <button type="button" class="btn-close" data-bs-dismiss="modal"
                                aria-label="Close"></button>
                        </div>
                        <div class="modal-body">
                            <input type="text" value="{{ $baptism->id ?? '1' }}" name="id" hidden>
                            <input type="text" value="{{ $baptism->user_id ?? '1' }}" name="user_id"
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control"
                                            value="{{ old('baby_firstname', $baptism->baby_firstname) }}"
                                            name="baby_firstname" id="baby_firstname"
                                            placeholder="Ingiza jina la kwanza la mtoto...">
                                        @error('baby_firstname')
                                ...
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" name="baby_middlename"
                                            value="{{ old('baby_middlename', $baptism->baby_middlename) }}"
                                            id="baby_middlename" placeholder="Ingiza jina la kati la mtoto...">
                                        @error('baby_middlename')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" name="baby_lastname"
                                            id="baby_lastname"
                                            value="{{ old('baby_lastname', $baptism->baby_lastname) }}"
                                            placeholder="Ingiza jina la mwisho la mtoto...">
                                        @error('baby_lastname')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="date" class="form-control" name="dateOfBirth"
                                            value="{{ old('dateOfBirth', $baptism->dateOfBirth) }}" id="dateOfBirth"
                                            placeholder="Ingiza tarehe ya kuzaliwa ya mtoto...">
                                        @error('dateOfBirth')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <label for="dateOfBaptism" class="form-label">Tarehe ya Kubatizwa
                                            (Mtoto)
                                        </label>
                                        <input type="date" class="form-control" name="dateOfBaptism"
                                            value="{{ old('dateOfBaptism', $baptism->dateOfBaptism) }}"
                                            id="dateOfBaptism" placeholder="Ingiza tarehe ya kubatizwa kwa mtoto...">
                                        @error('dateOfBaptism')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header border-o">
                        <h1 class="modal-title fs-5" id="deleteBaptismModal{{ $baptism->id }}Label">Futa Ubatizo
                        </h1>
                        <button type="button" class="btn-close" data-bs-dismiss="modal"
                            aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        <p>Unauwakika wa kufuta ubatizo huu wa mtoto mwenye jina <span
                                class="fst-italic text-success">{{ '#' . $baptism->baby_firstname . ' ' . $baptism->baby_middlename . ' ' . $baptism->baby_lastname }}</span>?
                        </p>
                    </div>
    ...
    <div class="modal fade" id="deleteSelectedBaptismModal" tabindex="-1"
        aria-labelledby="deleteSelectedBaptismModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header border-o">
