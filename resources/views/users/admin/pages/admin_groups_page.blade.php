...
<title> Mfumo wa Parokia | Makundi</title>
                ...
                <ul class="nav sidebar-menu flex-column" data-lte-toggle="treeview" role="menu"
                    ...
                    <li class="nav-item menu-open">
                        ...
                        <ul class="nav nav-treeview">
                            ...
                            <li class="nav-item">
                                <a href="{{ route('admin.groups.page') }}" class="nav-link active">
                                    <span class="mx-3"></span>
        ...
        <div class="app-content-header">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item fs-6">Vikundi</li>
                            <li class="breadcrumb-item active fs-6" aria-current="page">Orodha</li>
                        </ol>
                        <h3 class="mb-0 float-bold">Vikundi</h3>
                    </div>
                    <div class="col-sm-6">
                        <div style="padding: 14px 0"></div>
                        <button type="button" class="btn btn-primary float-end" data-bs-toggle="modal" data-bs-target="#addGroupModal"> Ongeza Kikundi</button>
                    </div>
                </div>
                <!--end::Row-->
            </div>
        ...
        <div class="modal-content">
            <form action="{{ route('addGroup') }}" method="POST" x-data="{ loading: false }" @submit.prevent="loading = true; $el.submit()">
                ...
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="addGroupModalLabel">Ongeza Kikundi</h1>
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" value="{{ old('name') }}" name="name" id="name" placeholder="Ingiza jina la kikundi">
