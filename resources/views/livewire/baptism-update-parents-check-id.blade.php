    ...
    <div class="col-md-6">
        <div class="mb-3">
            ...
            <input
                ...
                value="{{ old('father_member_id', $baptism?->father?->member_id) }}"
                id="father_member_id"
    ...
    <div class="col-md-6">
        <div class="mb-3">
            ...
            <input
                ...
                value="{{ old('mother_member_id', $baptism?->mother?->member_id) }}"
    ...
    <div class="col-md-6">
        <div class="mb-3">
            ...
            <input
                ...
                class="form-control"
                name="father_member_id"
                wire:model="inputFatherMemberId"
                wire:input="findFatherMemberId"
                id="father_member_id"
                placeholder="Ingiza namba ya mshirika ya baba...">
            ...
            @if ($fatherNameReturned)
                <div class="d-flex align-items-center">
                    ...
                    <div class="mt-2 {{ \Illuminate\Support\Str::startsWith($fatherNameReturned, 'Hakuna') ? 'text-danger' : 'text-success' }}">
                        {{ $fatherNameReturned }}
                    </div>
                </div>
            @endif
    ...
    <div class="col-md-6">
        <div class="mb-3">
            ...
            <input
                ...
                class="form-control"
                name="mother_member_id"
                wire:model="inputMotherMemberId"
                wire:input="findMotherMemberId"
                id="mother_member_id"
                placeholder="Ingiza namba ya mshirika ya mama...">
            ...
            @if ($motherNameReturned)
                <div class="d-flex align-items-center">
                    <span wire:loading.class="spinner-border spinner-border-sm me-2" role="status" aria-hidden="true"></span>
                    <div class="mt-2 {{ \Illuminate\Support\Str::startsWith($motherNameReturned, 'Hakuna') ? 'text-danger' : 'text-success' }}">
                        {{ $motherNameReturned }}
                    </div>
                </div>
            @endif
