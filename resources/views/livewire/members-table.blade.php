                                ...
                                <ul class="dropdown-menu dropdown-menu-end">
                                    <li>
                                        <button type="button" class="dropdown-item text-warning fw-semibold"
                                            data-bs-toggle="modal" data-bs-target="#" style="cursor: pointer;">
                                            <i class="bi bi-graph-up-arrow me-1"></i> Takwimu
                                        </button>
                                    </li>
                                    <li>
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        <h1 class="modal-title fs-5" id="viewMemberModal{{ $member->id }}Label">Tazama Mshirika
                        </h1>
                    ...
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" id="member_id" class="form-control fw-bold"
                                        value="{{ $member->user->name . '(' . Str::title($member->user->user_type) . ')' }}"
                                        readonly>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <input class="form-control fw-bold"
                                            value="{{ $member->ambassador ?? 'null' }}" readonly>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="mb-3">
                        ...
                        @if ($member->is_guest != 1)
                            <div class="mb-3">
                                ...
                                <input type="text" value="{{ $member->created_at }}"
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <input class="form-control fw-bold"
                                            value="{{ $member->group->name ?? 'null' }}" readonly>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="mb-3">
                        ...
                        <div class="modal-body">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" id="member_id"
                                            value="{{ old('member_id', $member->member_id) }}" class="form-control"
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="d-flex align-items-center gap-2 flex-wrap mx-3">
                                            <div class="form-check form-switch">
                                                @if ($member->is_guest == 1)
                                                    <input name="is_guest" class="form-check-input fs-4"
                                ...
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" id="firstname"
                                            value="{{ old('firstname', $member->firstname) }}" class="form-control"
                                ...
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" id="lastname"
                                            value="{{ old('lastname', $member->lastname) }}" class="form-control"
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        <label for="phone" class="form-label">Namba ya Simu</label>
                                        <input type="text" value="{{ old('phone', $member->phone) }}"
                                            id="phone" class="form-control" placeholder="Ingiza Namba ya Simu"
                                            name="phone">
                                        @error('phone')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                ...
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <input type="date" value="{{ old('dateOfBirth', $member->dateOfBirth) }}"
                                            ...
                                            placeholder="Ingiza Tarehe ya Kuzaliwa" name="dateOfBirth">
                                        @error('dateOfBirth')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" value="{{ old('street', $member->street) }}"
                                            id="street" class="form-control" placeholder="Ingiza Mtaa"
                                            name="street">
                                        @error('street')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                ...
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        <label for="group_id" class="form-label">Kikundi <span
                                ...
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <input type="text"
                                            value="{{ old('ambassador', $member->ambassador ?? 'null') }}"
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header border-o">
                        <h1 class="modal-title fs-5" id="deleteMemberModal{{ $member->id }}Label">Futa Mshirika
                        </h1>
                        <button type="button" class="btn-close" data-bs-dismiss="modal"
                            aria-label="Close"></button>
                    </div>
